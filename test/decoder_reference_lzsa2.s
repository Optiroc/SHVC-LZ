; Reference LZSA2 decompressor from https://github.com/emmanuel-marty/lzsa
; Adapted to ca65 by David Lindecrantz
;
; -----------------------------------------------------------------------------
...
BACKWARD_DECOMPRESS = 0                 ; 0 = forward decompress, 1 = backward decompress
RESERVE_BSS = 1                         ; reserve bss for decompressor
NIBCOUNT = $FC                          ; zero-page location for temp offset

.export ROM_DECOMPRESS_LZSA2
.export LZSA_SRC_LO, LZSA_SRC_HI, LZSA_SRC_BANK
.export LZSA_DST_LO, LZSA_DST_HI, LZSA_DST_BANK

ROM_DECOMPRESS_LZSA2:
.org $0100
DECOMPRESS_LZSA2_START:
   JSR @start
   RTL
@start:
...
DECOMPRESS_LZSA2_END:
.reloc
ROM_DECOMPRESS_LZSA2_END:

DECOMPRESS_LZSA2_SIZE = DECOMPRESS_LZSA2_END-DECOMPRESS_LZSA2_START-1
Reference_LZSA2_DecompressBlock = DECOMPRESS_LZSA2_SIZE
.export DECOMPRESS_LZSA2_SIZE

.if RESERVE_BSS = 1
   .segment "BSS"
   BSS_DECOMPRESS_LZSA2: .res DECOMPRESS_LZSA2_SIZE
   BSS_DECOMPRESS_LZSA2_END:
   .assert (BSS_DECOMPRESS_LZSA2 = $000100), error, "BSS_DECOMPRESS_LZSA2 not located at 0x000100"
   .export BSS_DECOMPRESS_LZSA2
.endif
